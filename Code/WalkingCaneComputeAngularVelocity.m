function w = WalkingCaneComputeAngularVelocityAngularVelocity(steeringDir, wMax)
%WalkingCaneComputeAngularVelocity Compute angular velocity
%   W = WalkingCaneComputeAngularVelocity(STEERINGDIR)
...
%
%   W = WalkingCaneComputeAngularVelocity(STEERINGDIR, WMAX)
%   returns the angular velocity W for a differential drive robot in radians
%   per second for a given steering direction STEERINGDIR in the robot's'
...
%   Example:
%       
%       w = WalkingCaneComputeAngularVelocity(0.2, 1);
...
validateattributes(steeringDir, {'double'},{'real'},...
    'WalkingCaneComputeAngularVelocity', 'STEERINGDIR', 1);
validateattributes(wMax, {'double'},{'real', 'positive'},...
    'WalkingCaneComputeAngularVelocity', 'WMAX', 2);
