classdef WalkingCaneVisualization < handle
    %WalkingCaneVisualization Visualize the localization process.
    % v = WalkingCaneVisualization(map) will create a visualization
    ...
    methods
        function obj = WalkingCaneVisualization(og)
